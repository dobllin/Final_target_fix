...
$donations_count = 0;
if ($conn->query("SELECT COUNT(*) as total FROM registered_users WHERE email = '$email'")) {
    $result = $conn->query("SELECT COUNT(*) as total FROM registered_users WHERE email = '$email'");
    ...
    <div class="header-top">
      <div class="container">
        ...
        <ul class="social-list">
          ...
          <li>
            <a href=https://www.instagram.com/nayakaihsanmuttaqn/ class="social-link">
...
<section class="password-change">
  ...
  <footer class="footer">
   ...
   <div class="footer-bottom">
     <div class="container">
       <p class="copyright">
         &copy; 2024 All Rights Reserved by Nayaka Ihsan Muttaqin
       </p>
       <ul class="social-list">
         <li>
           <a href="https://www.facebook.com/andro.pool.54?mibextid=ZbWKwL" class="social-link">
