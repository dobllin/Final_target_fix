...
Now type localhost in your browser and enter and go to phpMyAdmin section. There you need to add a new database named 'hospital'. Inside that create 2 tables named 'registered_users' and 'response_back'.<br>
